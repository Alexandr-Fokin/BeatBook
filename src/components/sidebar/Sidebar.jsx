  ...
  return (
    <div className={styles.sidebar}>
      <div className={styles.sidebar__header}>
        ...
        <a className={styles.sidebar__header_add_btn} onClick={toggleFormAddFolder}>
      ...
      <div style={{ display: folderForm ? "block" : "none" }} className={styles.sidebar__form_add_folder}>
