    ...
    <div className={styles.app}>
      ...
      <main className={styles.main}>
        <div className={styles.main_header}>
          <div className={styles.main_header__page_title}>{headerConfig.title}</div>
          <div className={styles.main_header__tools}>
            {headerConfig.tools?.includes("delete") && (
              <a
                ...
                onClick={() =>
                  setPopup(
                    <FormRemoveFolder folder={userData.folders.find((f) => f.id == folderId)}></FormRemoveFolder>
                  )
                }
              >
        ...
        <div className="main_box">
          ...
          {navigation.state !== "loading" && <Outlet context={{ setHeaderConfig }} />}
        </div>
      </main>
      <MenuBox />
      <Popup></Popup>
